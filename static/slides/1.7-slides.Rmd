...
- Parliament passed the .hi-purple[Bubble Act] in 1719, prohibited formation of a joint-stock company without a royal charter
  - Various public choice arguments behind this 
...
- Heavily interventionist State trying to promote growth
  ...
  - origin of “lassiez-faire, laissez-passer” as a retort to Colbert
]
...
.pull-left[
.smallest[
- Law establishes the *Compagnie du Mississippi*, funded by the Bank - a monopoly on trade in the French colonies in North America (primarily Louisiana)
...
- National debt would be paid off via the Mississippi Company revenue
  ...
  - Came up with exorbitant schemes to get more French from France into the Americas (there were only about 700 Europeans in Louisiana)
