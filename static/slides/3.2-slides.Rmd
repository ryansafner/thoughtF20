...
## [Second Generation Austrian Marginalists](#3)

## [Marginal Productivity Theory](#31)

## [Product Exhaustion & The Morality of Marginal Productivity](#36)
...
- .hi-green[Example]: consider a three-good society, services involved being $x$, $y$, and $z$, represented by three simultaneous equations:
...
- Assumes prices for final goods are given, and no substitution of factors
]
...
- A good start, but leads to wrong conclusion if followed too literally (horse, cart, etc)

- In truth, marginal product operates at infinitesimally small changes (derivative)
]
...
- Independently derived his own version of marginal utility theory

- Main popularizer of marginal productivity theory

- Opponent to American Institutionalists (see later)
...
- Viewed this as a *moral* feature of markets: each factor is paid for its contribution to society
...
.pull-left[
.smallest[
- Constant returns to scale: doubling all inputs $\implies$ double output
...
.pull-left[
.smallest[
- Decreasing returns to scale: doubling all inputs $\implies$ *less* than double output
$$f(cl,ck,ct)<cf(l,k,t) \quad \forall c>1$$
...
.pull-left[
.smallest[
- Increasing returns to scale: doubling all inputs $\implies$ *more* than double output
$$f(cl,ck,ct)>cf(l,k,t) \quad \forall c>1$$
...
- Wicksell showed that most firms actually go through all three phases of returns to scale
  - developing long-run U-shaped average cost curve for a firm
  - would take a few decades for neoclassical economists to deerive shape of AC curve
