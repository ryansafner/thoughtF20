...
- A "simpler, easier and quieter way" to fund government and end land monopoly is to "appropriate land rent for public use, by taxation"
...
annotate("segment", x = 2.5, xend = 2.5, y = 5, yend = 0, color = "purple", size=2.5, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))+
  geom_label(aes(x=2.5,y=2.5), color = "purple", label=expression(paste(tau==100),"%"), size = 5)+
