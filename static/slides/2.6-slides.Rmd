...
## [Ricardian Distribution Theory](#18)

## [The Bullion Controversy](#31)
...
- In reality, land does have a supply price that can create new land
...
.pull-left[
.smallest[
- Banking & currency controversy in early 19<sup>th</sup> century
...
.pull-right[
.center[
![:scale 65%](../images/bullionistcontroversy.jpg)
...
.right-column[
.smallest[
- First to discuss .hi-purple[velocity of money] in the quantity theory of money
  - Deflationary spiral from contraction of money & credit

- Thorough examination of role & history of Bank of England as lender of last resort
...
- First to see effects of .hi-purple[monetary disequilibrium] on real economy
...
- Led to famous debate between Ricardo & Malthus; John Maynard Keynes further revived & denounced it in 1936
  - Keynes’ (in)famous version of Say’s law: .hi-turquoise[“supply creates its own demand”] ❌

- Better summary by J.S. Mill: .hi-turquoise[“commodities are paid for by commodities (including money)”] ✅
...
> “But it may be asked, if this be so, .hi[how does it happen, that there is at times so great a glut of commodities] in the market, and so much difficulty in finding a vent for them? I answer that .hi[the glut of a particular commodity arises from its having outrun the total demand for it] in one or two ways; .hi[either because it has been produced in excessive abundance, or because the production of other commodities has fallen short],” I.XV.10
...
.pull-left[
.smallest[
- Sales *can* be dull with an excess demand for money

- People demand to hold more money (lower exchange value), stop spending money

- Decreased spending depresses sales, lowers price level (P), but raising purchasing power (PPM)

- Response:
  - under gold standard, gold flows in, or people mine more gold (more valuable)
  - under fiat standard ❓❓
...
ggplot(data = tibble(x = 1:10), aes(x =x))+
  stat_function(fun = m_d, geom = "line", color = "blue", size = 1)+
  geom_label(x = 2, y =m_d(2), label = "Money Demand", color = "blue")+
  geom_vline(xintercept = 5, size =2 , color ="red")+
  geom_label(x = 5, y =9.5, label = "Money Supply", color = "red")+
  ...
  labs(x = "Quantity of Money",
       y = expression(paste("Purchasing Power of Money, ", PPM==frac(1,P))))+
  scale_x_continuous(breaks = NULL,
                     limits = c(0,11),
                     expand = c(0,0))+
  scale_y_continuous(breaks = c(3,5),
                     labels = c(expression(hat(PPM)),expression(PPM^{o})),
                     limits = c(0,11),
                     expand = c(0,0))+
...
- Malthus could not articulate his opposition well, and had no alternative theory
  ...
  - was forgotten for a century, revived by Keynes
]
]